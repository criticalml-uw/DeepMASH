...
pred_risk_path = 'pred_risk.csv'
pred_death_risk_path = "pred_risk_death.csv"
pred_transplant_risk_path = "pred_risk_transplant.csv"
test_data_path = 'data/sample_test_data.csv'
...
parser.add_argument("-n", "--newdata", type = str, help = "Input path for new data")
parser.add_argument("-hyp", "--hypfile", type = str, help = "Hyperparameter file path")
parser.add_argument("-p", "--pred", type = str, help = "Output path for prediction file")
parser.add_argument("-d", "--death", type = str, help = "Output path for prediction file for death")
parser.add_argument("-t", "--transplant", type = str, help = "Output path for prediction file for transplant")

# Read arguments from command line
args = parser.parse_args()
 
if args.newdata:
  test_data_path = args.newdata
if args.hypfile:
  in_hypfile = args.hypfile
if args.pred:
  pred_risk_path = args.pred
if args.death:
  pred_death_risk_path = args.death
if args.transplant:
  pred_transplant_risk_path = args.transplant
...
processed_data = pd.read_csv(test_data_path, index_col=0)
...
out_no_index.to_csv(pred_risk_path)
...
pred_death_risk.to_csv(pred_death_risk_path)
pred_transplant_risk.to_csv(pred_transplant_risk_path)
